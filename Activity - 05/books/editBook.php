...
elseif($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($booksObj -> isBookExist($books["title"], $_GET["id"])){
...
<form action="" method="post">
    <input type="hidden" name="id" value="<?php $books["id"]  ?? "" ?>">
        <label for="">Field with <span>*</span> is required</label>
        <br>

        <label for="title">Book Name <span>*</span></label>
        <input type="text" name="title" id="title" class="pangalan" value="<?= $books["title"] ?>">
        <p class="error"><?= $errors["title"] ?? "" ?></p>
        <br>

        <label for="author">Author <span>*</span></label>
        <input type="text" name="author" id="author" class="pangalan" value="<?= $books["author"] ?>">
        <p class="error"><?= $errors["author"] ?? ""?></p>
        <br>

        <label for="genre">Genre <span>*</span></label>
        <select name="genre" id="genre" class="pangalan">
        ...
        <input type="text" name="publication_year" id="publication_year" class="pangalan" value="<?= $books["publication_year"] ?>">
        <p class="error"><?= $errors["publication_year"] ?? ""?></p>
        <br>

        <label for="publisher">Publisher </label> 
        <input type="text" name="publisher" id="publisher" class="pangalan" value="<?= $books["publisher"] ?>">
        <br><br>

        <label for="copies">Number of Copies <span>*</span></label> 
        <input type="number" name="copies" id="copies" class="pangalan" value="<?= $books["copies"] ?>">
