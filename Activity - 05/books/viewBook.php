...
<head>
    ...
    <link rel="stylesheet" href="viewDes.css">
</head>
<body>
    <h1>View Books</h1>
    ...
    <table border="1">
        ...
        foreach($booksObj->viewBooks($search, $genre) as $books) {
            $message = "Are you sure you want to delete the book ". $books["title"] . "?";
        ?>
        ...
        <tr>
            ...
            <td> <?= $books["copies"] ?> </td>
            <td>
                <a href="editBook.php?id=<?= $books["id"] ?>">EDIT</a>
                <a href="deleteBook.php?id=<?= $books["id"] ?>" onclick="return confirm('<?= $message ?>')">DELETE</a>
            </td>
        </tr>
